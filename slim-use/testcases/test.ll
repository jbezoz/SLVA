...
if.else:                                          ; preds = %entry
  ...
  %5 = load i32, i32* %c, align 4, !dbg !37
...
while.cond:                                       ; preds = %while.body, %if.end
  %6 = load i32, i32* %a, align 4, !dbg !41
  %7 = load i32, i32* %b, align 4, !dbg !42
  %cmp2 = icmp sle i32 %6, %7, !dbg !43
  br i1 %cmp2, label %while.body, label %while.end, !dbg !40

while.body:                                       ; preds = %while.cond
  %8 = load i32, i32* %a, align 4, !dbg !44
...
while.end:                                        ; preds = %while.cond
  ...
  %10 = load i32, i32* %b, align 4, !dbg !50
  %add3 = add nsw i32 %9, %10, !dbg !51
  %11 = load i32, i32* %c, align 4, !dbg !52
  %add4 = add nsw i32 %add3, %11, !dbg !53
  ret i32 %add4, !dbg !54
}
